...
public class PoolManager : MonoBehaviour
{
    ...
    // <summary>
    // Reuse a gameobject component in the pool. 'prefab' is the prefab gameobject containing the component. 'position' is the world position for the gameobject
    // 'quaternion' is the rotation for the gameobject
    // </summary>
    public Component ReuseComponent(GameObject prefab, Vector3 position, Quaternion rotation)
    {
        ...
        {
            UnityEngine.Debug.LogWarning("No object pool for " + prefab);
            return null;
        }
    }
