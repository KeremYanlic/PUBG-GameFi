...
[CreateAssetMenu(fileName = "SoundEffect_",menuName = "Scriptable Objects/Weapon/SoundEffectSO")]
public class SoundEffectSO : ScriptableObject
{
    ...
    {
        UtilsClass.ValidateCheckEmptyString(this, nameof(soundEffectName), soundEffectName);
        UtilsClass.ValidateCheckNullValue(this, nameof(soundPrefab), soundPrefab);
        UtilsClass.ValidateCheckNullValue(this, nameof(soundEffectClip), soundEffectClip);
        UtilsClass.ValidateCheckPositiveRange(this, nameof(soundEffectPitchRandomVariationMin), soundEffectPitchRandomVariationMin, nameof(soundEffectPitchRandomVariationMax), soundEffectPitchRandomVariationMax);
        UtilsClass.ValidateCheckPositiveValue(this, nameof(soundEffectVolume), soundEffectVolume, true);
    }
#endif
    #endregion
}
