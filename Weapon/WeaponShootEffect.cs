...
public class WeaponShootEffect : MonoBehaviour
{
    ...
    public void SetShootEffect(WeaponShootEffectSO weaponShootEffectSO)
    {
    ...
    // <summary>
    // Set the shoot effect particle system burst,particle number
    // </summary>
    ...
    private void SetShootEffectVelocityOverLifeTime(Vector3 velocityOverLifetimeMin, Vector3 velocityOverLifetimeMax)
    {
        ...
        minMaxCurveX.mode = ParticleSystemCurveMode.TwoConstants;
        minMaxCurveX.constantMin = velocityOverLifetimeMin.y;
        minMaxCurveX.constantMax = velocityOverLifetimeMax.y;
        velocityOverLifetimeModule.y = minMaxCurveY;

        //Define min max Z velocity
        ParticleSystem.MinMaxCurve minMaxCurveZ = new ParticleSystem.MinMaxCurve();
        minMaxCurveX.mode = ParticleSystemCurveMode.TwoConstants;
        minMaxCurveX.constantMin = velocityOverLifetimeMin.z;
        minMaxCurveX.constantMax = velocityOverLifetimeMax.z;
